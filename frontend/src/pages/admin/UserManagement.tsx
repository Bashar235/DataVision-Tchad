...
import { Users, UserPlus, Search, ShieldAlert, UserCog, MoreHorizontal, Loader2, RefreshCw, Trash2, Eye, EyeOff, ChevronLeft } from "lucide-react";
...
export const UserManagementTabContent = () => {
                            ...
                            <TableBody>
                                {filteredUsers.map((user) => (
                                    ...
                                    >
                                        ...
                                        <TableCell className="text-sm text-muted-foreground text-start whitespace-nowrap">
                                            {user.last_login ? (() => {
                                                try {
                                                    const date = new Date(user.last_login);
                                                    if (isNaN(date.getTime())) return user.last_login;
...
const UserManagement = () => {
    ...
    return (
        <div className="flex min-h-screen bg-background text-start">
            {/* Main Content Area */}
