...
const Profile = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12 mt-4">

      {/* Header */}
      <div className="text-start">
        <h1 className="text-2xl font-extrabold mb-2 text-slate-950 tracking-tight">{t('profile_settings_title')}</h1>
        <p className="text-slate-700 font-medium">{t('profile_settings_subtitle')}</p>
      </div>
          ...
          <Card className="bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl overflow-hidden p-2">
            ...
            <CardContent className="space-y-6 pt-6">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="department" className="text-sm font-semibold text-slate-400 ml-1">{t('profile_department')} {t('profile_locked_suffix')}</Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="institution" className="text-sm font-semibold text-slate-400 ml-1">{t('profile_institution')} {t('profile_locked_suffix')}</Label>
          ...
          <Card className="bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl overflow-hidden p-2">
            ...
            <CardContent className="pt-2">
              <div className={`flex items-center gap-3 p-3 rounded-xl bg-blue-50/50 border border-blue-100 text-blue-700 ${isRtl ? 'flex-row-reverse' : ''}`}>
                ...
                <span className="text-sm font-medium">{t('profile_password_last_changed')}</span>
              </div>
            </CardContent>
          </Card>
